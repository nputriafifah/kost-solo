...
import { 
  ArrowLeft, MapPin, Wind, MessageCircle, Heart, 
  ShieldCheck, Zap, User, Star, Trash2, Car, 
  Bath, Bed, Utensils, Train, Bus, Map as MapIcon,
  Maximize, Users, Store, Church, GraduationCap, Hospital, ShoppingBag, Wifi, Coffee, Navigation2, CheckCircle2
} from "lucide-react";
      ...
      <div className="max-w-[1300px] mx-auto px-6 md:px-10 py-12">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="flex-1">
            ...
            {/* C. LOKASI SEKITAR (SESUAI GAMBAR) */}
            <section className="mb-16">
              ...
              <div className="relative w-full h-[350px] bg-slate-100 rounded-3xl overflow-hidden mb-8 group shadow-inner">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <button className="bg-white px-6 py-3 rounded-xl shadow-2xl text-sm font-bold text-slate-700 hover:bg-slate-50 border border-slate-100">
            ...
            <section className="bg-slate-900 p-8 rounded-[32px] text-white shadow-xl mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  "Maksimal 2 penghuni (ada biaya tambahan)",
                  "Dilarang membawa hewan peliharaan",
                  "Lawan jenis dilarang masuk kamar",
                  "Menjaga ketenangan setelah jam 22.00",
                  "Dilarang merokok di dalam kamar AC"
                ].map((rule, index) => (
          ...
          <div className="w-full lg:w-[400px]">
            <div className="sticky top-10 bg-white border border-slate-200 rounded-[40px] p-8 shadow-2xl shadow-slate-100">
              ...
              <button className="w-full bg-white text-slate-600 border-2 border-slate-200 font-bold py-4 rounded-2xl hover:bg-slate-50 transition-all">
                Tanya Pemilik
              </button>
            </div>
          </div>
