...
export default function RoleButton({ title, desc, icon, onClick }) {
  return (
    ...
    >
      <div className="flex items-center justify-center mr-4 border border-blue-100 w-11 h-11 bg-blue-50 rounded-xl">
        {icon}
      </div>
      ...
      <ChevronLeft
        size={16}
        className="transition-colors rotate-180 text-slate-300 group-hover:text-blue-500"
      />
    </button>
  );
}