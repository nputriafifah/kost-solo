...
export default function RoleSelector({ onSelectRole }) {
  return (
    <div className="fade-in">
      <span className="inline-flex items-center gap-1.5 text-[11px] bg-indigo-50 text-indigo-600 font-semibold px-3 py-1.5 rounded-full uppercase tracking-wider border border-indigo-100">
